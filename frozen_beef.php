...
<body>
    ...
    <div class="container">
        ...
        <div class="product">
            <img src="image/manu/a1.jpg" alt="My Heart" class="product-img">
            <h3>เนื้อบดเบอร์เกอร์ แช่แข็ง (5 ชิ้น-แพ็ก)</h3>
            <p>ราคา: 250 บาท</p>
            <button>สั่งซื้อ</button>
        </div>
        <div class="product">
            <img src="image/manu/a2.jpg" alt="Sunshine Love" class="product-img">
            <h3>เนื้อใบพายออสเตรเลีย สไลซ์ แช่แข็ง</h3>
            <p>ราคา: 120 บาท </p>
            <button>สั่งซื้อ</button>
        </div>
        <div class="product">
        ...
        <div class="product">
            ...
            <h3>เนื้อสันนอกวัว แช่แข็ง ออสเตรเลีย ตัดสเต๊ก </h3>
            <p>ราคา: 150 บาท </p>
            <button>สั่งซื้อ</button>
        </div>
        <div class="product">
            <img src="image/manu/a7.jpg" alt="Graceful Love" class="product-img">
            <h3>เนื้อสันนอกออสเตรเลีย สไลซ์ </h3>
            <p>ราคา: 200 บาท </p>
            <button>สั่งซื้อ</button>
        </div>
        ...
        <div class="product">
            <img src="image/manu/a10.jpg" alt="Graceful Love" class="product-img">
            <h3>เนื้อเสือร้องไห้ออสเตรเลีย สไลซ์ แช่แข็ง</h3>
            <p>ราคา: 100 บาท </p>
            <button>สั่งซื้อ</button>
        </div>
        <div class="product">
            <img src="image/manu/a11.jpg" alt="Graceful Love" class="product-img">
            <h3>เนื้อสันแหลมนิวซีแลนด์ ตัดสเต๊ก (พรีเมียม) แช่แข็ง</h3>
            <p>ราคา: 180 บาท </p>
            <button>สั่งซื้อ</button>
        </div>
        <div class="product">
